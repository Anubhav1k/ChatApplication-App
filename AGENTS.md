...
- **API endpoints**: Prefixed with `http://localhost:3001/api/`

#### Example API Routes
- `GET http://localhost:3001/api/ping` - Simple ping api
- `GET http://localhost:3001/api/demo` - Demo endpoint  
...
app.get("http://localhost:3001/api/my-endpoint", handleMyRoute);
```
